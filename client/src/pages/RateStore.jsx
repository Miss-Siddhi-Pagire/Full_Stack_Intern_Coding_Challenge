  ...
  return (
    <div className="max-w-xl mx-auto py-8">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border dark:border-gray-700 overflow-hidden">
        <div className="bg-indigo-600 p-10 text-white relative text-center overflow-hidden">
          ...
          <p className="text-indigo-100 font-medium">{store.address}</p>
        </div>
        ...
        <div className="p-10 text-center space-y-8">
          ...
          <div className="pt-6 border-t dark:border-gray-700">
            <button
              ...
              className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black text-lg shadow-indigo-200 dark:shadow-none shadow-xl hover:bg-indigo-700 disabled:opacity-50 transition-all flex items-center justify-center gap-3"
            >
              {loading ? (
